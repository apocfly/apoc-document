...
1. 科学性: 基于航空通信与人因工程原理设计。
2. 单义性: 每个术语只对应一个明确含义。
3. 简明性: 用语简短，减少信道占用和误听可能。
4. 习惯性: 遵循长期形成的行业惯例，便于传承。
5. 系统性: 构成完整的术语体系，覆盖各类场景。
6. 国际性: 具备跨文化通用性，适应全球运行需求。
7. 口语性: 适合实时语音交互，表达自然流畅。
8. 准确性: 信息传递精确，不允许模糊表述。
9. 程序性: 严格遵循标准操作程序，确保一致性。
10. 指令性: 具有法律效力，须无条件执行。
...
5. 本手册中的`高度`如果没有特别注明均为泛指，可代表各种高度。
...
首次联系时，空中交通管制员采用的通话结构应为：`对方完整呼号 + 己方呼号 + 通话内容`  
首次通话以后的各次通话，空中交通管制员可以采用下列通话结构：`对方呼号 + 通话内容`  
航空器驾驶员采用的通话结构应为：`*对方呼号 + 己方完整呼号 + 通话内容`  
...
| 3300m | 三千三  | 9500m  | 九千五  |
| 3600m | 三千六  | 9800m  | 九千八  |
| 3900m | 三千九  | 10100m | 幺洞幺  |
| 4200m | 四两   | 10400m | 幺洞四  |
| 4500m | 四千五  | 10700m | 幺洞拐  |
| 4800m | 四千八  | 11000m | 幺幺洞  |
| 5100m | 五幺   | 11300m | 幺幺三  |
| 5400m | 五千四  | 11600m | 幺幺六  |
| 5700m | 五拐   | 11900m | 幺幺九  |
| 6000m | 六千   | 12200m | 幺两两  |
| 6300m | 六千三  | 12500m | 幺两五  |

### 7.2 米制高度层英语读法

按顺序读出即可

`1200m`读作`one thousand two hundred meters`  
...
`3000ft`读作`三千英尺`  
`12000ft(FL120)`读作`高度层幺两洞`。

### 7.4 英制高度层的英语读法

读法：`X + feet`、`flight level + X`

`3000ft`读作`tree thousand feet`  
`12000ft(FL120)`读作`flight level wun too zero`。

## 8. 时间的读法

如果无特殊说明的情况下，默认使用国际协调时UTC，直接按顺序读出数字即可，英文同理。

比如`09:00`读作`洞九洞洞`，`10:15`读作`幺洞幺五`
